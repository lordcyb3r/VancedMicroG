...
package app.revanced.android.gms.location.places;

import android.net.Uri;

import app.revanced.android.gms.common.data.Freezable;
...
public interface Place extends Freezable<Place> {
     ...
     * <p/>
     * The address is localized according to the locale returned by {@link app.revanced.android.gms.location.places.Place#getLocale()}.
     */
    CharSequence getAddress();

    /**
     * Returns the attributions to be shown to the user if data from the {@link app.revanced.android.gms.location.places.Place} is used.
     * <p/>
     ...
     * <p/>
     * This ID can be passed to {@link app.revanced.android.gms.location.places.GeoDataApi#getPlaceById(app.revanced.android.gms.common.api.GoogleApiClient, java.lang.String...)} to lookup the same place at a later
     ...
     * <p/>
     * The name is localized according to the locale returned by {@link app.revanced.android.gms.location.places.Place#getLocale()}.
     */
