...
package app.revanced.android.gms.common.security;

import static app.revanced.android.gms.security.ProviderInstaller.PROVIDER_NAME;
...
import app.revanced.android.gms.org.conscrypt.Conscrypt;
import app.revanced.android.gms.org.conscrypt.NativeCrypto;
    ...
    public static void insertProvider(Context context) {
        ...
        try {
            ...
            synchronized (lock) {
                ...
                if (res == 1) {
                    Security.setProperty("ssl.SocketFactory.provider", "app.revanced.android.gms.org.conscrypt.OpenSSLSocketFactoryImpl");
                    Security.setProperty("ssl.ServerSocketFactory.provider", "app.revanced.android.gms.org.conscrypt.OpenSSLServerSocketFactoryImpl");
