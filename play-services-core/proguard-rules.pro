...
-keep public class app.revanced.android.gms.common.security.ProviderInstallerImpl { public *; }
-keep public class app.revanced.android.gms.cast.framework.internal.CastDynamiteModuleImpl { public *; }
...
-keep class app.revanced.android.gms** { *; }
