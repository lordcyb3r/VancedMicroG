...
package app.revanced.android.gms.auth.api.credentials;
...
public class Credential extends AutoSafeParcelable {
     ...
     * any string, it is strongly recommended that values from {@link app.revanced.android.gms.auth.api.credentials.IdentityProviders}
