...
public final class GcmConstants {
    ...
    public static final String ACTION_NOTIFICATION_OPEN = "app.revanced.android.gms.gcm.NOTIFICATION_OPEN";
    public static final String ACTION_NOTIFICATION_DISMISS = "app.revanced.android.gms.gcm.NOTIFICATION_DISMISS";
    public static final String ACTION_SCHEDULE = "app.revanced.android.gms.gcm.ACTION_SCHEDULE";
    public static final String ACTION_TASK_READY = "app.revanced.android.gms.gcm.ACTION_TASK_READY";
    public static final String ACTION_TASK_INITIALZE = "app.revanced.android.gms.gcm.SERVICE_ACTION_INITIALIZE";
    public static final String ACTION_INSTANCE_ID = "app.revanced.android.gms.iid.InstanceID";
    ...
    public static final String EXTRA_PENDING_INTENT = "app.revanced.android.gms.gcm.PENDING_INTENT";
    ...
    public static final String PERMISSION_NETWORK_TASK = "app.revanced.android.gms.permission.BIND_NETWORK_TASK_SERVICE";
