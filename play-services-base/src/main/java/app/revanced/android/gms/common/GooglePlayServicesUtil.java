...
public class GooglePlayServicesUtil {
     ...
     *                  returned to your application via {@link app.revanced.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener#onConnectionFailed(ConnectionResult)}
